...
public class StoredProcedures {
    ...
    public static final String RETRIEVE_ADS_BY_FILTERS = "{CALL retrieveAdsByFilters(?, ?)}"; // retrieveAdsByFilters(FiltersBean filtersBean, Point2D uniCoordinates)
    ...
    public static final String RETRIEVE_ROOM_IMAGE = "{CALL retrieveRoomImage(?)}"; // getRoomImage(int idRoom)
